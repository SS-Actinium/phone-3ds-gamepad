...
A debug APK is attached to the [GitHub release](https://github.com/SS-Actinium/phone-3ds-gamepad/releases/tag/v0.2.1) and, if you built locally, at:

`dist/HingePad-0.2.1-debug.apk`
