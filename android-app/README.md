...
Use `../dist/HingePad-0.2.0-debug.apk` (or the GitHub release asset). Uninstall the old Hinge Pad first if Android blocks the update. Copy it to the phone, allow unknown-app installs, then open the file.
